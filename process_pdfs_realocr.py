...
def main():
    # 定义输入和输出文件夹
    input_folder = "/Users/yuanliang/Downloads/testpdf/OCRmyPDF处理结果"
    output_folder = "/Users/yuanliang/Downloads/testpdf/OCRmyPDF处理结果/realocrmypdf"
    ...
    filtered_pdf_files = [
        ...
        if not f.startswith(output_folder)
    ]
    
    print(f"\n找到 {len(filtered_pdf_files)} 个PDF文件需要处理")
    ...
    print(f"总计: {len(filtered_pdf_files)} 个文件")
